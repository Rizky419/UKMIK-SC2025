# GAME DEV - Study Club UKM IK 2025

Panduan khusus untuk peserta Study Club Topik GAME DEV. File ini menjelaskan cara mengumpulkan tugas dengan sistem **submit link repository**.

## 🎯 Tujuan

Folder `GAME-DEV/` adalah tempat pengumpulan link repository tugas terkait game-dev.
...
1. **Buat repository public** di GitHub untuk tugas Anda
   ...
   - Nama: `game-dev-pertemuan-[N]`
   - Contoh: `game-dev-pertemuan-1`
   - Set **Public** ✅
...
4. **Update dan buat branch**
   ...
   git checkout -b submit/game-dev-pertemuan-nama
   ```

5. **Edit file README.md** di folder pertemuan

   - Buka: `GAME-DEV/PERTEMUAN-[N]/README.md`
...
6. **Commit dan push**
   ...
   ```bash
   git add .
   git commit -m "Submit tugas game-dev pertemuan [N] - [NAMA]"
   git push origin submit/game-dev-pertemuan-nama
   ```
...
| Nama     | NIM    | Repository                                                              |
| -------- | ------ | ----------------------------------------------------------------------- |
| John Doe | 123456 | [game-dev-pertemuan-1](https://github.com/johndoe/game-dev-pertemuan-1) |
```
